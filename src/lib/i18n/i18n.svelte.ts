...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'file.renamePlaceholder': 'New name or template...',
    ...
    'rules.actionMoveLabel': 'Move to Directory',
    'rules.actionRenameLabel': 'Rename File',
    'rules.destinationPath': 'Destination Path',
    'rules.renameTemplate': 'Rename Template',
  ...
  zh: {
    ...
    'file.renamePlaceholder': '输入新文件名或命名模板...',
    ...
    'rules.noRulesDesc': '创建规则以自动在监控目标中移动、重命名文件或将其移至回收站。',
    ...
    'rules.actionMoveLabel': '移动至目录',
    'rules.actionRenameLabel': '重命名文件',
    'rules.destinationPath': '目标路径',
    'rules.renameTemplate': '重命名模板',
    'rules.saveRule': '保存规则',
