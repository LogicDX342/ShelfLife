...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'settings.targetTtlDays': 'Target TTL (Days)',
    'settings.targetTtlInherited': 'TTL inherits global {days} days',
    'settings.targetTtlOverride': 'TTL: {days} days',
    'settings.targetTtlInheritPlaceholder': 'Inherit {days}',
    'settings.hiddenFoldersSkipped': 'Hidden folders are skipped automatically.',
  ...
  zh: {
    ...
    'dashboard.selected': '已选择 {count} 个',
    'status.review': '待清理',
    'status.tracked': '已监控',
    ...
    'settings.targetTtlDays': '目标过期时间 (天)',
    'settings.targetTtlInherited': '继承全局 {days} 天',
    'settings.targetTtlOverride': '过期时间: {days} 天',
    'settings.targetTtlInheritPlaceholder': '继承 {days}',
    'settings.hiddenFoldersSkipped': '隐藏文件夹会自动跳过。',
