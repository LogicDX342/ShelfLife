...
<div class="space-y-6 pb-16">
  <!-- Header -->
  <header class="border-b border-fluent-border-light dark:border-fluent-border-dark pb-4">
      ...
      <div class="space-y-6">
        ...
        <section class="fluent-card p-6 space-y-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <label class="flex flex-col gap-1.5">
              ...
              <select
                ...
                onchange={(e) => i18n.setLang((e.target as HTMLSelectElement).value as 'en' | 'zh')}
              >
          ...
          <div class="flex items-center gap-3 pt-2 select-none">
            <span class="text-xs font-semibold text-fluent-muted-light dark:text-fluent-muted-dark"
